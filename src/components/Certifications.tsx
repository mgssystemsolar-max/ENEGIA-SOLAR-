      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            <div key={i} className="bg-white dark:bg-solar-dark p-8 rounded-2xl shadow-sm hover:shadow-md transition text-center group">
              ...
              <h3 className="font-bold text-lg mb-2 text-solar-dark dark:text-white">{item.title}</h3>
