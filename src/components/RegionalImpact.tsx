...
export default function RegionalImpact() {
  ...
  return (
    <section className="py-20 bg-gray-50 dark:bg-solar-card transition-colors duration-300">
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="lg:w-1/2">
            ...
            <div className="bg-white dark:bg-solar-dark p-6 rounded-2xl shadow-lg border-l-4 border-solar-orange mb-8">
              <div className="flex items-start gap-4">
                <div className="bg-solar-orange/10 p-3 rounded-full text-solar-orange shrink-0">
                  <i className="fas fa-certificate text-2xl"></i>
                </div>
                <div>
                  <h3 className="font-bold text-lg text-solar-dark dark:text-white mb-1">Qualidade Comprovada</h3>
          ...
          <div className="lg:w-1/2 w-full">
            <div className="bg-white dark:bg-solar-dark rounded-3xl p-8 shadow-xl border border-gray-100 dark:border-white/5 relative overflow-hidden">
              ...
              <h3 className="text-xl font-bold mb-6 text-center text-solar-dark dark:text-white flex items-center justify-center gap-2">
                <i className="fas fa-map-marked-alt text-solar-orange"></i> Cidades Atendidas
              </h3>
              
              <div className="grid grid-cols-2 sm:grid-cols-2 gap-4">
                {cities.map((city, index) => (
                  <div key={index} className="flex items-center gap-3 p-3 rounded-xl bg-gray-50 dark:bg-white/5 hover:bg-solar-orange/10 dark:hover:bg-solar-orange/20 transition-colors group cursor-default">
